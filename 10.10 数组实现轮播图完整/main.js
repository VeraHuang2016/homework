...
(function () {
    ...
    * */
    ...
    //    给下一页 上一页 按钮 添加 响应事件
        ...
        addMouseEvent(document.querySelector("#carousel .nextButton"));
        addMouseEvent(document.querySelector("#carousel .preButton"));
    }

    function updatePointStatus() {
        document.getElementById("selectPoint").id = "";
        document.getElementsByClassName("pointButton")[index].id = "selectPoint";
    }
